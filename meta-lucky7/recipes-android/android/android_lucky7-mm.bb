...
SRC_URI = "https://dl.dropboxusercontent.com/s/j3lbzk349k2qtn6/hybris-m-msm8226.tar.gz;name=hybris \
    https://dl.dropboxusercontent.com/s/pny53u172fyheh4/system-lucky7-m.tar.gz;name=system \
"
...
# FIXME: QA Issue: Architecture did not match (40 to 164) on /work/lucky7-oe-linux-gnueabi/android/lollipop-r0/packages-split/android-system/system/vendor/firmware/adsp.b00 [arch]
do_package_qa() {
}
